    ...
    <Grid item xs={12} sm={4} ref={ref}>
      <div className={classes.root}>
        <div className={classes.left}>
          ...
          <Typography className={classes.title} component="div" variant="body2">{title}</Typography>
        </div>
        <div className={classes.right}>
          <div className={classes.value}>
            {inView ? <StatCore value={value} /> : <span>0</span>}
          </div>
          <Typography className={classes.label} variant="body1" component="div">{label}</Typography>
        </div>
      </div>
    </Grid>
  );
